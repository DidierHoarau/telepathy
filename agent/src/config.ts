...
class Config {
  //
  public static readonly CLIENT_VERSION_FILE: string = '/opt/telepathy/version-agent';
  public static readonly CONFIG_FILE: string = '/etc/telepathy/config-agent.json';
  public CLIENT_ARCH: string = 'telepathy-agent-linux-x64';
